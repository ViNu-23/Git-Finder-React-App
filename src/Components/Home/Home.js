...
import "./Home.css";
import { Stack, Button, Input, Badge, useToast} from "@chakra-ui/react";
  ...
  return (
    <>
      ...
      <div className="input-search">
        ...
        {inputValue&&(
          <Button colorScheme="green" variant="solid" type="submit" onClick={handleSearchBtnClick}>
          <Search2Icon />
        </Button>
        )}
        ...
        {isClearVisible && (
        <div className="clear">
          <Button colorScheme="gray" variant="solid" type="submit" ml="2" onClick={handleClearBtnClick} mr='6'>
            <CloseIcon />
          </Button>
        </div>
      )}
